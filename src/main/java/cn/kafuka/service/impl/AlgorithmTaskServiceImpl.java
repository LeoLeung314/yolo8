            ...
            if(reqTaskStatus == 1){
                if(inferType.equals("onnx")) {
                    ...
                    if (os.contains("linux")) {
                        ...
                        cmdList.add(String.valueOf(pushFrequency));
                        //resultMap = ShellCommandExecutorUtil.callProcess(workDir + "onnx_infer/",cmdList);
                        resultMap = ShellCommandExecutorUtil.callProcessNoBlockWindows(workDir + "tensorrt_infer/", cmdList);
                    }
                }else {
                    ...
                    if (os.contains("linux")) {
                        ...
                        cmdList.add("yolo_env");
                        cmdList.add("python");
                        cmdList.add("yolov8_detect_tensorrt.py");
                        cmdList.add("--engine");
                        cmdList.add(modelKey + ".engine");
                        cmdList.add("--video_url");
                        cmdList.add(videoPlayUrl);
                        cmdList.add("--stream_server_url");
                        cmdList.add(streamServerUrl);
                        cmdList.add("--skip_frame");
                        cmdList.add(String.valueOf(skipFrame));
                        cmdList.add("--push_frq");
                        cmdList.add(String.valueOf(pushFrequency));
