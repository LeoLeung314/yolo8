...
public class LoginController {
    ...
    public ResultVo<Map<String, Object>> login(
        ...
        log.error("========== 进入 /login 接口 ==========");
        String plain = userLoginReqDto.getPassword();          // 123456
        String salt  = "kfk20ac23sj99kfk";
        String hash  = org.apache.commons.codec.digest.DigestUtils.sha256Hex(plain + salt);
        log.error("[Login] 后端明文：{}，盐值：{}，最终 SHA256：{}", plain, salt, hash);
